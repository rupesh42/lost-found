...
/**
 * This implementation saves the mock users automatically. 
 * It will also send the details of all users if asked for.
 * @author Rupesh
 *
 */
@Service
public class LostandFoundUserServiceImpl implements CommandLineRunner, LostandFoundUserService {
	...
	private final LnFUserRepository userRepository;

	@Autowired
	public LostandFoundUserServiceImpl(LnFUserRepository userRepository) {
