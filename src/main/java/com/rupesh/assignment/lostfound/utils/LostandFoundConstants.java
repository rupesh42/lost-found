...
public class LostandFoundConstants {
	...
	public static final String QUANTITY_LESS_THAN_REQUESTED = "Not enough quantity available to claim.";

	public static final String ITEM_ALREADY_CLAIMED = " This item has already been claimed by another user. However, Also";
